...
const TERMS = [
  {
    ...
    weeks: [
      ...
      },
      {
        ...
        tue1:  { id: 'l7a',  topic: 'Cell Biology',        group: 'cell', notes: '' },
        tue2:  { id: 'l7b',  topic: 'Cell Biology',        group: 'cell', notes: '' },
        weds:  { id: 'l7w',  topic: 'NEA Session',         group: 'nea',  notes: '' },
        fri1:  { id: 'l7c',  topic: 'Cell Biology',        group: 'cell', notes: '' },
        fri2:  { id: 'l7d',  topic: 'Cell Biology',        group: 'cell', notes: '' },
      },
      {
        weekNum: 8, month: 'November', dateLabel: '9th',
        tue1:  { id: 'l8a',  topic: 'Cell Biology',        group: 'cell', notes: '' },
        tue2:  { id: 'l8b',  topic: 'Cell Biology',        group: 'cell', notes: '' },
        weds:  { id: 'l8w',  topic: 'NEA Session',         group: 'nea',  notes: '' },
        fri1:  { id: 'l8c',  topic: 'Cell Biology',        group: 'cell', notes: '' },
        fri2:  { id: 'l8d',  topic: 'Cell Biology',        group: 'cell', notes: '' },
      },
      {
        weekNum: 9, month: 'November', dateLabel: '16th',
        tue1:  { id: 'l9a',  topic: 'Transport',           group: 'transport', notes: '' },
        tue2:  { id: 'l9b',  topic: 'Transport',           group: 'transport', notes: '' },
        weds:  { id: 'l9w',  topic: 'NEA Session',         group: 'nea',  notes: '' },
        fri1:  { id: 'l9c',  topic: 'Transport',           group: 'transport', notes: '' },
        fri2:  { id: 'l9d',  topic: 'Transport',           group: 'transport', notes: '' },
      },
      {
        weekNum: 10, month: 'November', dateLabel: '23rd',
        tue1:  { id: 'l10a', topic: 'Transport',           group: 'transport', notes: '' },
        tue2:  { id: 'l10b', topic: 'Transport',           group: 'transport', notes: '' },
        weds:  { id: 'l10w', topic: 'NEA Session',         group: 'nea',  notes: '' },
        fri1:  { id: 'l10c', topic: 'Transport',           group: 'transport', notes: '' },
        fri2:  { id: 'l10d', topic: 'Transport',           group: 'transport', notes: '' },
      },
      {
        weekNum: 11, month: 'November', dateLabel: '30th',
        tue1:  { id: 'l11a', topic: 'Genetics',            group: 'genetics', notes: '' },
        tue2:  { id: 'l11b', topic: 'Genetics',            group: 'genetics', notes: '' },
        weds:  { id: 'l11w', topic: 'NEA Session',         group: 'nea',  notes: '' },
        fri1:  { id: 'l11c', topic: 'Genetics',            group: 'genetics', notes: '' },
        fri2:  { id: 'l11d', topic: 'Genetics',            group: 'genetics', notes: '' },
      },
      {
        weekNum: 12, month: 'December', dateLabel: '7th',
        tue1:  { id: 'l12a', topic: 'Genetics',            group: 'genetics', notes: '' },
        tue2:  { id: 'l12b', topic: 'Genetics',            group: 'genetics', notes: '' },
        weds:  { id: 'l12w', topic: 'NEA Session',         group: 'nea',  notes: '' },
        fri1:  { id: 'l12c', topic: 'Genetics',            group: 'genetics', notes: '' },
        fri2:  { id: 'l12d', topic: 'Genetics',            group: 'genetics', notes: '' },
      },
      {
        weekNum: 13, month: 'December', dateLabel: '14th',
        tue1:  { id: 'l13a', topic: 'Term 1 Revision',     group: 'revision', notes: '' },
        tue2:  { id: 'l13b', topic: 'Term 1 Assessment',   group: 'revision', notes: 'Formal assessment' },
        weds:  null,
        fri1:  { id: 'l13c', topic: 'Term 1 Revision',     group: 'revision', notes: '' },
        fri2:  { id: 'l13d', topic: 'Feedback & Review',   group: 'revision', notes: '' },
      },
      {
        weekNum: null, month: 'December', dateLabel: '21st',
        isHoliday: true, holidayLabel: 'CHRISTMAS HOLIDAY',
      },
    ]
  },
  {
    ...
    weeks: [
      {
        weekNum: 14, month: 'January', dateLabel: '6th',
        tue1:  { id: 'l14a', topic: 'Cardiovascular System', group: 'physiology', notes: '' },
        tue2:  { id: 'l14b', topic: 'Cardiac Cycle & ECG',   group: 'physiology', notes: '' },
        weds:  { id: 'l14w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l14c', topic: 'Blood Vessels & BP',    group: 'physiology', notes: '' },
        fri2:  { id: 'l14d', topic: 'Blood Components',      group: 'physiology', notes: '' },
      },
      {
        weekNum: 15, month: 'January', dateLabel: '13th',
        tue1:  { id: 'l15a', topic: 'Haemoglobin & O₂',     group: 'transport', notes: '' },
        tue2:  { id: 'l15b', topic: 'CO₂ Transport',         group: 'transport', notes: '' },
        weds:  { id: 'l15w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l15c', topic: 'Respiratory System',    group: 'physiology', notes: '' },
        fri2:  { id: 'l15d', topic: 'Gas Exchange',          group: 'physiology', notes: '' },
      },
      {
        weekNum: 16, month: 'January', dateLabel: '20th',
      ...
      },
      {
        ...
        fri2:  { id: 'l17d', topic: 'Antibiotic Resistance', group: 'microbes', notes: '' },
      },
      {
        weekNum: 18, month: 'February', dateLabel: '3rd',
        tue1:  { id: 'l18a', topic: 'Nervous System',        group: 'physiology', notes: '' },
      ...
      },
      {
        ...
        isHoliday: true, holidayLabel: 'FEBRUARY HALF TERM',
      },
      {
        weekNum: 19, month: 'February', dateLabel: '17th',
        tue1:  { id: 'l19a', topic: 'Homeostasis',           group: 'physiology', notes: '' },
        tue2:  { id: 'l19b', topic: 'The Kidney',            group: 'physiology', notes: '' },
        weds:  { id: 'l19w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l19c', topic: 'Thermoregulation',      group: 'physiology', notes: '' },
        fri2:  { id: 'l19d', topic: 'Musculoskeletal System', group: 'physiology', notes: '' },
      },
      {
        weekNum: 20, month: 'February', dateLabel: '24th',
        tue1:  { id: 'l20a', topic: 'Muscle Contraction',    group: 'physiology', notes: '' },
        tue2:  { id: 'l20b', topic: 'Exercise Physiology',   group: 'physiology', notes: '' },
        weds:  { id: 'l20w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l20c', topic: 'Reproduction',          group: 'physiology', notes: '' },
        fri2:  { id: 'l20d', topic: 'Fertilisation & Dev.',  group: 'physiology', notes: '' },
      },
      {
        weekNum: 21, month: 'March', dateLabel: '3rd',
        tue1:  { id: 'l21a', topic: 'Ecology',               group: 'ecology', notes: '' },
        tue2:  { id: 'l21b', topic: 'Nutrient Cycles',       group: 'ecology', notes: '' },
        weds:  { id: 'l21w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l21c', topic: 'Evolution',             group: 'ecology', notes: '' },
        fri2:  { id: 'l21d', topic: 'Classification',        group: 'ecology', notes: '' },
      },
      {
      ...
      {
        weekNum: 23, month: 'March', dateLabel: '17th',
        tue1:  { id: 'l23a', topic: 'Term 2 Revision',       group: 'revision', notes: '' },
        tue2:  { id: 'l23b', topic: 'Mid-Year Assessment',   group: 'revision', notes: 'Formal assessment' },
        weds:  null,
        fri1:  { id: 'l23c', topic: 'Term 2 Revision',       group: 'revision', notes: '' },
        fri2:  { id: 'l23d', topic: 'Feedback & Review',     group: 'revision', notes: '' },
      },
      {
        weekNum: null, month: 'March', dateLabel: '24th',
        isHoliday: true, holidayLabel: 'EASTER HOLIDAY',
      },
    ]
  },
  {
    ...
    weeks: [
      {
        weekNum: 24, month: 'April', dateLabel: '22nd',
        tue1:  { id: 'l24a', topic: 'Practical Skills',      group: 'revision', notes: '' },
        tue2:  { id: 'l24b', topic: 'Data Analysis',         group: 'revision', notes: '' },
        weds:  { id: 'l24w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l24c', topic: 'Exam Technique',        group: 'revision', notes: '' },
        fri2:  { id: 'l24d', topic: 'Command Words',         group: 'revision', notes: '' },
      },
      {
        weekNum: 25, month: 'April', dateLabel: '29th',
        tue1:  { id: 'l25a', topic: 'Final Revision: Unit 1', group: 'revision', notes: '' },
        tue2:  { id: 'l25b', topic: 'Final Revision: Unit 2', group: 'revision', notes: '' },
        weds:  { id: 'l25w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l25c', topic: 'Mock Paper Practice',   group: 'revision', notes: '' },
        fri2:  { id: 'l25d', topic: 'Mock Paper Review',     group: 'revision', notes: '' },
      },
      {
        weekNum: 26, month: 'May', dateLabel: '6th',
        tue1:  { id: 'l26a', topic: 'Exam Prep: Cell & Transport', group: 'revision', notes: '' },
        tue2:  { id: 'l26b', topic: 'Exam Prep: Genetics',   group: 'revision', notes: '' },
        weds:  { id: 'l26w', topic: 'NEA Session',           group: 'nea',  notes: '' },
        fri1:  { id: 'l26c', topic: 'Exam Prep: Physiology', group: 'revision', notes: '' },
        fri2:  { id: 'l26d', topic: 'Exam Prep: Health',     group: 'revision', notes: '' },
      },
      {
        weekNum: null, month: 'May', dateLabel: '13th',
        isHoliday: true, holidayLabel: 'MAY HALF TERM',
      },
      {
        weekNum: 27, month: 'May', dateLabel: '20th',
        tue1:  { id: 'l27a', topic: 'End-of-Year Exam',      group: 'revision', notes: 'Formal end-of-year exam' },
        tue2:  { id: 'l27b', topic: 'End-of-Year Exam',      group: 'revision', notes: 'Formal end-of-year exam' },
        weds:  null,
        fri1:  { id: 'l27c', topic: 'Results Review',        group: 'revision', notes: '' },
        fri2:  { id: 'l27d', topic: 'Enrichment / Feedback', group: 'revision', notes: '' },
      },
      {
        weekNum: 28, month: 'June', dateLabel: '3rd',
        tue1:  { id: 'l28a', topic: 'Enrichment Project',    group: 'revision', notes: '' },
        tue2:  { id: 'l28b', topic: 'Enrichment Project',    group: 'revision', notes: '' },
        weds:  null,
        fri1:  { id: 'l28c', topic: 'Enrichment Project',    group: 'revision', notes: '' },
        fri2:  { id: 'l28d', topic: 'Enrichment Project',    group: 'revision', notes: '' },
      },
    ]
  }
];
